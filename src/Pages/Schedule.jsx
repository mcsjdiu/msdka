...
const Schedule = () => {
    ...
    piketGroup = [
        ["Rizka", "Iqbal", "Mitro", "Dzulhaq", "Noval", "Satria", "Zulfan"],
        ["Andhika", "Aulyvia", "Arsya", "Arya", "Dico", "Rafif"],
        ["Aldebaran", "Aldi", "Almira", "Bagas", "Friska", "Redho"],
        ["Chello", "Fachry", "Hanif", "Marvello", "Panca", "Nizhar", "Nouval"],
        ["Agniya", "Alif", "Harisa", "Aji", "Tiansyah", "Raissa"],
    ]
